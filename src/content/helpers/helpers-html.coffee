...
module.exports.register = (Handlebars, options) ->
  ...
  Handlebars.registerHelper "glyphicon", (attachment) ->
    extension = attachment.substr(attachment.lastIndexOf(".") + 1)
    value = Handlebars.Utils.escapeExpression(extension)
    switch value
      when "jpg", "jpeg", "png", "gif"
  ...
  # Handlebars.registerHelper "icon", (symbol, title, options) ->
  #   ariaLabel = ""
  #   ariaLabel = " aria-label=\"" + title + "\""  if title and options
  #   Utils.safeString "<i class=\"icon icon-" + symbol + "\"" + ariaLabel + "></i>"
  ...
  Handlebars.registerHelper "push", (options) ->
    ...
    if section
      ...
      item = Utils.safeString(options.fn(this))
      if name
