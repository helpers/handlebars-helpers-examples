...
page.filename: glob-sortby-path.md
page.pagename: glob-sortby-path.md
page.basename: glob-sortby-path
page.extname:  
page.ext:      
...
#### glob-sortby-path.md
dirname:       dist/paths
filename:      glob-sortby-path.md
pagename:      glob-sortby-path.md
basename:      glob-sortby-path
extname:       
ext:           
